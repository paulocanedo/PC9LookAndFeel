...
public class ShadowRenderer {
    ...
    public BufferedImage createShadow(final BufferedImage src) {
        return createShadow(src, null);
    }
     ...
     * height = imageHeight + 2 * shadowSize
     * </pre>
     * @param src the picture from which the shadow must be cast
     * @return the picture containing the shadow of <code>image</code> 
     */
    public BufferedImage createShadow(final BufferedImage src, BufferedImage dst) {
        ...
        if (dst == null) {
            dst = new BufferedImage(dstWidth, dstHeight,
        ...
        GraphicsUtilities.getPixels(src, 0, 0, srcWidth, srcHeight, srcBuffer);
